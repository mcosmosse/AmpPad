        ...
        return ( 
            <div className='splash-header'>
                ...
                <div className='splash-header-text'>
                    <h1 className='header-intro'>Hi, we're Amppad.</h1>
                    <h3 className='header-description'>A clone of the world's most-loved social storytelling platform.</h3>
                    <p className='header-text'>Amppad connects a global community of 65 readers and writers through the power of story.</p>
